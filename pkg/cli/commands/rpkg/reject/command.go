...
// NewCommand returns the cobra command for `rpkg reject`, which rolls
// a Proposed package revision back to Draft, or moves a deletion-
// proposed revision back to Published when an approver declines the
