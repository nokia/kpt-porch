...
// WatchPackageRevisions provides a mock function for the type MockWatcherManager
func (_mock *MockWatcherManager) WatchPackageRevisions(ctx context.Context, filter repository.ListPackageRevisionFilter, callback engine.ObjectWatcher) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, repository.ListPackageRevisionFilter, engine.ObjectWatcher) error); ok {
...
func (_c *MockWatcherManager_WatchPackageRevisions_Call) Run(run func(ctx context.Context, filter repository.ListPackageRevisionFilter, callback engine.ObjectWatcher)) *MockWatcherManager_WatchPackageRevisions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 engine.ObjectWatcher
		if args[2] != nil {
			arg2 = args[2].(engine.ObjectWatcher)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockWatcherManager_WatchPackageRevisions_Call) Return(err error) *MockWatcherManager_WatchPackageRevisions_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockWatcherManager_WatchPackageRevisions_Call) RunAndReturn(run func(ctx context.Context, filter repository.ListPackageRevisionFilter, callback engine.ObjectWatcher) error) *MockWatcherManager_WatchPackageRevisions_Call {
	_c.Call.Return(run)
	return _c
}
