...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.21.0 object:headerFile="../../../../scripts/boilerplate.go.txt",year=$YEAR_GEN crd:crdVersions=v1 output:crd:artifacts:config=. paths=./...
