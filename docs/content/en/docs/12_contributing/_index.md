...
type: docs
weight: 12
description: How to contribute to Porch documentation and codebase
---
...
See the [EasyCLA documentation](https://docs.linuxfoundation.org/lfx/easycla/v2-current/contributors) for details.
