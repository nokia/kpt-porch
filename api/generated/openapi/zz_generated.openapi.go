...
func schema_kptdev_porch_api_porch_PackageRevision(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch.PackageRevisionSpec", "github.com/kptdev/porch/api/porch.PackageRevisionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_kptdev_porch_api_porch_PackageRevisionResources(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch.PackageRevisionResourcesSpec", "github.com/kptdev/porch/api/porch.PackageRevisionResourcesStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_kptdev_porch_api_porch_PorchPackage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Package",
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch.PackageSpec", "github.com/kptdev/porch/api/porch.PackageStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PackageRevision(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PackageRevisionSpec", "github.com/kptdev/porch/api/porch/v1alpha1.PackageRevisionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PackageRevisionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PackageRevision", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PackageRevisionResources(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PackageRevisionResourcesSpec", "github.com/kptdev/porch/api/porch/v1alpha1.PackageRevisionResourcesStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PackageRevisionResourcesList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PackageRevisionResources", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PackageRevisionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.Condition", "github.com/kptdev/porch/api/porch/v1alpha1.Locator", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PorchPackage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PackageSpec", "github.com/kptdev/porch/api/porch/v1alpha1.PackageStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_PorchPackageList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.PorchPackage", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha1_ResultList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha1.Result", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_porch_api_porch_v1alpha2_PackageRevision(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kptdev/porch/api/porch/v1alpha2.PackageRevisionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kptdev/porch/api/porch/v1alpha2.PackageRevisionStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kptdev/porch/api/porch/v1alpha2.PackageRevisionSpec", "github.com/kptdev/porch/api/porch/v1alpha2.PackageRevisionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
