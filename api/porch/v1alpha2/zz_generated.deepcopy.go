...
func (in *PackageRevisionSpec) DeepCopyInto(out *PackageRevisionSpec) {
	*out = *in
	...
	if in.SubpackageOperation != nil {
		in, out := &in.SubpackageOperation, &out.SubpackageOperation
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubpackageOperation) DeepCopyInto(out *SubpackageOperation) {
	*out = *in
	if in.CloneFrom != nil {
		in, out := &in.CloneFrom, &out.CloneFrom
		*out = new(UpstreamPackage)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubpackageOperation.
func (in *SubpackageOperation) DeepCopy() *SubpackageOperation {
	if in == nil {
		return nil
	}
	out := new(SubpackageOperation)
